...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 30-Set-2021 às 20:06
...
--
CREATE DATABASE IF NOT EXISTS `ods6.1` DEFAULT CHARACTER SET utf8 COLLATE utf8_swedish_ci;
USE `ods6.1`;
...
CREATE TABLE IF NOT EXISTS `doador` (
  ...
  `senha` varchar(250) COLLATE utf8_swedish_ci NOT NULL,
